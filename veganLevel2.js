...
resetVegan:function(){
  ...
  for(i = 0; i < stKor2; i++){
    mapV2.putTile(3, indPobrKor2[i].x, indPobrKor2[i].y);
    console.log( stKor2 + " " + i + " k " + indPobrKor2[i].x + " " + indPobrKor2[i].y);
  }
...
getKorencek:function(){
  if(mapV2.getTile(layerV2.getTileX(veganka.x), layerV2.getTileY(veganka.y), layerV2, true).index != -1){
    ...
    indPobrKor2[stKor2-1] = koorPobrKor;
      console.log(stKor2 + "  " + indPobrKor2[stKor2-1].x + " " + indPobrKor2[stKor2-1].y);
